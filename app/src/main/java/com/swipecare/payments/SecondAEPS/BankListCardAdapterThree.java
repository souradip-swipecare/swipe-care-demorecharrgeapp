...
import com.swipecare.payments.AEPSMiniStatementActivity;
import com.swipecare.payments.R;

import java.util.List;

public class BankListCardAdapterThree extends RecyclerView.Adapter<BankListCardAdapterThree.ViewHolder> {

    Context context;
    List<BankListItems> operators_items;

    public BankListCardAdapterThree(Context context, List<BankListItems> operators_items) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            view.setOnClickListener(view1 -> {
                ...
                ((AEPSMiniStatementActivity) context).mGetBank(item.getId(), item.getBank(), item.getBankiin());
                AEPSMiniStatementActivity.alertDialog_for_bank.dismiss();
            });
        }
    }
